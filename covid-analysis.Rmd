...
ggplot(normed_deaths,
  ...
  labs(title = 'Daily Deaths of COVID-19 in 5 Major Texas Cities',
       subtitle = '',
       y = 'log(Daily Deaths)',
...
ggplot(subset(normed_deaths, Date > (Sys.Date() - 14)),
  ...
  labs(title = 'Daily Deaths of COVID-19 over Last 2 Weeks',
       subtitle = Sys.Date(),
       y = 'Daily Deaths',
       x = '# Days since First Recorded Death') + 
  theme_pubr() + 
...
ggplot(normed_deaths %>% group_by(Location) %>% mutate(cv = cumsum(Value)),
  ...
  scale_y_log10() +
  expand_limits(x = (max(normed_deaths$Day_norm) * 1.1)) +
  labs(title = 'Cumulative Deaths of COVID-19 in 5 Major Texas Cities',
       subtitle = '',
       y = 'Cumulative Deaths',
       x = '# Days since First Recorded Death') + 
  theme_pubr() + 
