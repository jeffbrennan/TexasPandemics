...
# TEMP FIX: DSHS upload "11-31" instead of "11-01"
# TODO check on 11/2, 11/3 and replace when fixed
colnames(DSHS_deaths_time) = gsub('11-31', '10-31', colnames(DSHS_deaths_time))
