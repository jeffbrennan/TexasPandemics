...
PHR_helper = data.frame(PHR = c( "1", "11", "2/3", "4/5N", "6/5S", "7", "8", "9/10"),
...
#   dplyr::select(-c(hospital_pk, collection_week, County, TSA_Combined, PHR_Combined,
#                    fips_code, state, ccn, hospital_name, address, zip))
# 
# harris_hosp_table = tableby(hospital_subtype ~ .,  data = harris_hosp)
#   
# # summary(harris_hosp_table, ')
# 
# # write2html(harris_hosp_table, 'original-sources/helpers/unpublished/harris_hospitals.html',
