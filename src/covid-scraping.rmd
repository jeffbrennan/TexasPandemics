...
# 
# 
# hosp_df = read.csv(paste0('https://healthdata.gov/sites/default/files/reported_hospital_capacity_admissions_facility-level_weekly_average_timeseries_', hosp_date_f, '.csv'))
