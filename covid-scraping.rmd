...
# https://stackoverflow.com/questions/9691319/new-to-json-java-what-datatype-is-this-a-datetime-13-digits-long-using-php
hhs_date = as.Date(format(as.POSIXct(get_hhs_date/1000, origin="1970-01-01"), '%Y-%m-%d'))
...
# calculate daily cases after rbind
