...
# TODO: add to repository in sep folder for longitudinal database
...
# DSHS_alf_counts = read_excel_allsheets(url('https://dshs.texas.gov/coronavirus/COVID-19OutbreaksinLong-termCareFacilities.xlsx'))

# write.xlsx(DSHS_alf_counts, 'original-sources/DSHS_alf_counts.xlsx')
```

```{r}
# DSHS_alf = read.xlsx(url('https://dshs.texas.gov/coronavirus/COVID-19inALFsoverTimebyRegion.xlsx'))

# write.xlsx(DSHS_alf, 'original-sources/DSHS_alf.xlsx')
```


```{r}
# DSHS_nursing = read.xlsx(url('https://dshs.texas.gov/coronavirus/COVID-19inNursingHomesoverTimebyRegion.xlsx'))

# write.xlsx(DSHS_nursing, 'original-sources/DSHS_nursing.xlsx')
```
