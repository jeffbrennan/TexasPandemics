...
county_counts = Reduce(function(x, y) merge(x, y, by = c('Date', 'County'), all=TRUE),
       list(DSHS_cases_long, DSHS_new_cases_long, DSHS_deaths_long, DSHS_tests_long, DSHS_active_cases_long, county_childcare_df))
# 
...
DSHS_case_age <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 9),
                        lapply(demo.list[67:103], read_excel, sheet = 10))

DSHS_case_gender <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 10),
                           lapply(demo.list[67:103], read_excel, sheet = 11))

DSHS_case_race <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 11),
                        lapply(demo.list[67:103], read_excel, sheet = 12))

DSHS_death_age <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 12),
                         lapply(demo.list[67:103], read_excel, sheet = 13))

DSHS_death_gender <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 13),
                            lapply(demo.list[67:103], read_excel, sheet = 14))

DSHS_death_race <- append(lapply(demo.list[c(1:66, 104:length(demo.list))], read_excel, sheet = 14),
