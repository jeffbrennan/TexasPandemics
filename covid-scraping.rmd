...
# drop cols
COVID_TRACKING_trash_cols = c('total', 'posNeg', 'lastUpdateEt', 'dateModified', 'checkTimeEt', 'hash', 'pending', 'hospitalized', 'dateChecked', 'total',
                              'posNeg',	'deathIncrease', 'hospitalizedIncrease', 'hash', 'commercialScore',	'negativeRegularScore',	'negativeScore',
...
colnames(COVID_TRACKING_texas) = c('Date', 'State', 'Positive_Total', 'Negative_Total',
                                   ...
                                   'Quality', 'Deaths_Total', 'FIPS', 'Positive_New', 'Negative_New', 'Tests_Total', 'Tests_New')
