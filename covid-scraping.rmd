...
DSHS_new_cases_long = rbindlist(lapply(list.files(path = 'original-sources/dshs-new-cases', full.names = TRUE),
  ...
  mutate(Cases_Daily = gsub(',', '', as.character(Cases_Daily), fixed = TRUE)) %>% 
...
hosp_cap1 = DSHS_hosp_clean(DSHS_tsa_hosp_cap[[5]], 'Beds_Available_Total')
hosp_cap2 = DSHS_hosp_clean(DSHS_tsa_hosp_cap[[6]], 'Beds_Available_ICU')
hosp_cap3 = DSHS_hosp_clean(DSHS_tsa_hosp_cap[[7]], 'Beds_Occupied_Total')
hosp_cap4 = DSHS_hosp_clean(DSHS_tsa_hosp_cap[[8]], 'Beds_Occupied_ICU')
```
...
## School reopening (DEFUNCT ON 9/23)
