...
tsa.hosp.arima<-write.csv(TSA.arima.df.1, "statistical-output/tsa_hosp_timeseries.csv", row.names=FALSE)
texas.hosp.arima<-write.csv(texas.arima.df.1, "statistical-output/state_hosp_timeseries.csv", row.names=FALSE)
```
