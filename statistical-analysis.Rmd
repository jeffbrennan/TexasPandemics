...
county.focus.rt.output<-covid.rt(county.focus.cast, threshold=case_quant)
write.csv(county.focus.rt.output, "nine_county_rt_estimates.csv", row.names = FALSE)


# plot with shaded confidence intervals
rt.plot<-function(rt.data){
  library(ggplot2)
...
county.focus.plot<-rt.plot(county.focus.rt.output)
ggsave("nine_county_rt_plot.png", width=20, height=10, unit="cm")
```
