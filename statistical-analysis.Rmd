...
criteria_results = case_criteria %>% group_by(Level_Name) %>%
  summarize_at(vars(criteria1, criteria2, criteria3), funs(sum))
```
...
combined_current_ratio_dat = combined_current_ratio_dat %>% 
